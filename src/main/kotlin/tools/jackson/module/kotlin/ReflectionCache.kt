...
import tools.jackson.databind.util.LRUMap
...
internal class ReflectionCache(reflectionCacheSize: Int) {
    ...
    private val javaConstructorToValueCreator = LRUMap<Constructor<Any>, tools.jackson.module.kotlin.ConstructorValueCreator<*>>(reflectionCacheSize, reflectionCacheSize)
