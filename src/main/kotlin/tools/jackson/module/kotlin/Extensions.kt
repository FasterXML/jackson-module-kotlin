...
fun jacksonObjectMapper(): ObjectMapper =
    _root_ide_package_.tools.jackson.module.kotlin.jsonMapper { addModule(_root_ide_package_.tools.jackson.module.kotlin.kotlinModule()) }
...
fun ObjectMapper.registerKotlinModule(): ObjectMapper = this.registerModule(_root_ide_package_.tools.jackson.module.kotlin.kotlinModule())

inline fun <reified T> jacksonTypeRef(): TypeReference<T> = object: TypeReference<T>() {}

inline fun <reified T> ObjectMapper.readValue(jp: JsonParser): T = readValue(jp,
    _root_ide_package_.tools.jackson.module.kotlin.jacksonTypeRef<T>()
)
inline fun <reified T> ObjectMapper.readValues(jp: JsonParser): MappingIterator<T> = readValues(jp,
    _root_ide_package_.tools.jackson.module.kotlin.jacksonTypeRef<T>()
)

inline fun <reified T> ObjectMapper.readValue(src: File): T = readValue(src,
    _root_ide_package_.tools.jackson.module.kotlin.jacksonTypeRef<T>()
)
inline fun <reified T> ObjectMapper.readValue(src: URL): T = readValue(src,
    _root_ide_package_.tools.jackson.module.kotlin.jacksonTypeRef<T>()
)
inline fun <reified T> ObjectMapper.readValue(content: String): T = readValue(content,
    _root_ide_package_.tools.jackson.module.kotlin.jacksonTypeRef<T>()
)
inline fun <reified T> ObjectMapper.readValue(src: Reader): T = readValue(src,
    _root_ide_package_.tools.jackson.module.kotlin.jacksonTypeRef<T>()
)
inline fun <reified T> ObjectMapper.readValue(src: InputStream): T = readValue(src,
    _root_ide_package_.tools.jackson.module.kotlin.jacksonTypeRef<T>()
)
inline fun <reified T> ObjectMapper.readValue(src: ByteArray): T = readValue(src,
    _root_ide_package_.tools.jackson.module.kotlin.jacksonTypeRef<T>()
)

inline fun <reified T> ObjectMapper.treeToValue(n: TreeNode): T = readValue(this.treeAsTokens(n),
    _root_ide_package_.tools.jackson.module.kotlin.jacksonTypeRef<T>()
)
inline fun <reified T> ObjectMapper.convertValue(from: Any): T = convertValue(from,
    _root_ide_package_.tools.jackson.module.kotlin.jacksonTypeRef<T>()
)

inline fun <reified T> ObjectReader.readValueTyped(jp: JsonParser): T = readValue(jp,
    _root_ide_package_.tools.jackson.module.kotlin.jacksonTypeRef<T>()
)
inline fun <reified T> ObjectReader.readValuesTyped(jp: JsonParser): Iterator<T> = readValues(jp,
    _root_ide_package_.tools.jackson.module.kotlin.jacksonTypeRef<T>()
)
inline fun <reified T> ObjectReader.treeToValue(n: TreeNode): T? = readValue(this.treeAsTokens(n),
    _root_ide_package_.tools.jackson.module.kotlin.jacksonTypeRef<T>()
)
...
// https://github.tools/jackson-module-kotlin/issues/464
