...
class TestPropertyRequiredness {
    ...
    @Test fun shouldHandleFalseFailOnNullForPrimitives() {
        val mapper = jacksonMapperBuilder().configure(DeserializationFeature.FAIL_ON_NULL_FOR_PRIMITIVES, false).build()
    ...
    @Test fun shouldHandleTrueFailOnNullForPrimitives() {
        val mapper = jacksonMapperBuilder().configure(DeserializationFeature.FAIL_ON_NULL_FOR_PRIMITIVES, true).build()
        val testClass = TestClass::class.java
