...
class TestGithub114 {
    ...
    data class Obj(val id: String, val prop: String) {
        companion object {
            ...
            fun parse(@JsonProperty("id") id: String,
                      @JsonProperty("name") name: String? = null) = Obj(id, name ?: "yes")
        }
    }
    ...
    fun testCallByFunctionalityWithCompanionObjects() {
        ...
        println(v2.callBy(mapOf(v2.parameters.first() to FooWithStaticCreator.Companion, v2.parameters.drop(1).first() to "asdf")))
    }
