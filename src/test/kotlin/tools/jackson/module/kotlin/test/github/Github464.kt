...
class Github464 {
    class UnboxTest {
        ...
        fun test() {
            ...
            val writer: ObjectWriter = _root_ide_package_.tools.jackson.module.kotlin.jacksonObjectMapper()
        ...
        fun nullValueSerializerTest() {
            @Suppress("UNCHECKED_CAST")
            val writer = _root_ide_package_.tools.jackson.module.kotlin.jacksonObjectMapper()
                .apply {
