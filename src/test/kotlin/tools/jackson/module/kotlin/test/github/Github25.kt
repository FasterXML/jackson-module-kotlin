...
class TestGithub25 {
    ...
    @Test fun testSerWithDelegates() {
        val json = _root_ide_package_.tools.jackson.module.kotlin.jacksonObjectMapper()
    ...
    @Test fun testDeserWithDelegates() {
        ...
        val obj: SomethingWithDelegates = _root_ide_package_.tools.jackson.module.kotlin.jacksonObjectMapper().readValue(json)
