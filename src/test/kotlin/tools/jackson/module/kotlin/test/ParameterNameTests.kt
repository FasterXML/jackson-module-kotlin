...
class TestJacksonWithKotlin {
    ...
    private val normalCasedMapper = _root_ide_package_.tools.jackson.module.kotlin.jacksonObjectMapper()
            .configure(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS, false)
            .configure(SerializationFeature.INDENT_OUTPUT, false)


    private val pascalCasedMapper = _root_ide_package_.tools.jackson.module.kotlin.jacksonObjectMapper()
            .configure(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS, false)
            .configure(SerializationFeature.INDENT_OUTPUT, false)
